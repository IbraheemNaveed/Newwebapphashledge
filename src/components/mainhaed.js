...
const mainhead = () => {
    return (
   <>
    <section className='flex flex-col sm:flex-row justify-between py-8 px-4 mx-auto max-w-screen-xl  lg:py-16 lg:px-12   '>
      <div>
        
<div class=" px-6 py-12 md:px-8 text-center md:text-left mt-8 md:w-2/3 w-full">
    <a href="#">
        <h5 class="mb-6  text-5xl font-bold tracking-tight text-gray-900 dark:text-red-800">IT Consultancy That Puts The End-User At The Heart Of The Process</h5>
    </a>
    <p class="mb-6 font-normal text-2xl text-gray-700 dark:text-gray-700">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
