    ...
    <div class="relative px-6 lg:px-8 bg-opacity-60 ">
      <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
        <div>
          ...
          <div>
            <h1 class="text-4xl font-display text-[#852727] text-center tracking-wide sm:text-[56px] flex flex-col gap-10  " >If IT Consulting is an ART  <br/>  <a className="sm:text-3xl text-xl " > We are the MICHAELANGELOS  of this sphere</a></h1>
